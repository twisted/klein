...
Klein uses `Epydoc <http://epydoc.sourceforge.net/manual-epytext.html>`_ for docstrings in code and uses `Sphinx <http://www.sphinx-doc.org/en/master/>`_ for standalone documentation.
